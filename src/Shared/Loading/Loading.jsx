...
const Loading = ({ message = "Loading...", height = "min-h-screen", background_color = "bg-blue-50" }) => {
  return (
    <div className={`w-full flex flex-col items-center justify-center ${height} ${background_color} gap-6`}>
      {/* Hourglass Icon */}
      <HiOutlineClock
