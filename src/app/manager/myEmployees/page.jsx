// arc/app/manager/myEmployees/page.jsx
"use client";
...
// Modal
import Edit_User_Modal from '@/app/admin/employees/Edit_User_Modal/Edit_User_Modal';
import View_User_Modal from '@/app/admin/employees/View_User_Modal/View_User_Modal';
import Add_New_User_Modal from '@/app/admin/employees/Add_New_User_Modal/Add_New_User_Modal';

// Date Fns
import { formatDistanceToNow } from 'date-fns';

// Components
import DeptId_To_Name from '@/app/admin/employees/DeptId_To_Name/DeptId_To_Name';
...
const MyEmployeesPage = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(`/users/MyEmployees/${session?.user?.userId}`, {
        params: {
          page: currentPage,
          limit: itemsPerPage,
                    ...
                    <td className="py-3 px-4 whitespace-nowrap text-sm text-left">
                      <div className="flex items-center gap-3 md:gap-4">
                        ...
                        <div className="shrink-0">
                          <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gray-200 flex items-center justify-center text-gray-800 font-bold">
            ...
            Users.map((user) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  {/* Avatar */}
                  <div className="shrink-0">
                    <div className="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center text-gray-800 font-bold">
                      {getUserInitials(user?.personal?.name)}
                    </div>
                  </div>
