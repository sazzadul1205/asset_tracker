                      ...
                      <div className="flex items-center gap-3 md:gap-4">
                        ...
                        <div className="flex flex-col min-w-0">
                          <h3 className="font-semibold text-gray-800 text-sm truncate">
                            {asset?.identification?.name || "Asset Name"}
                          </h3>
                          <p className="text-gray-500 text-xs truncate">
                            {asset?.identification?.tag || "Asset Tag"}
                          </p>
                        </div>
                      </div>
                    </td>
                  ...
                  <td colSpan={7} className="py-12 text-center">
                    <div className="flex flex-col items-center justify-center gap-3">
                      ...
                      <p className="text-gray-400 text-sm text-center px-4">
                        Adjust your filters or add a new Asset.
                      </p>
                    </div>
                  </td>
                </tr>
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2 pt-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-xs rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition"
                  >
                    <FaEye className="text-sm" />
                    View
                  </button>
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-xs rounded-lg bg-green-600 text-white hover:bg-green-700 transition"
                  >
                    <MdEdit className="text-sm" />
                    Edit
                  </button>
                  <button
                    onClick={() => handleDeleteAsset(asset)}
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-xs rounded-lg bg-red-600 text-white hover:bg-red-700 transition"
                  >
                    <FaRegTrashAlt className="text-sm" />
                    Delete
                  </button>
