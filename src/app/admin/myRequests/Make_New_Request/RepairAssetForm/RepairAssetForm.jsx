// src/app/admin/myRequests/Make_New_Request/RepairAssetForm/RepairAssetForm.jsx
...
const RepairAssetForm = ({
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setGlobalError(error.error || "Failed to create repair request. Please try again.");
    } finally {
      setLoading(false);
    }
  };
